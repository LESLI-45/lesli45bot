...
ИСПРАВЛЕННАЯ ВЕРСИЯ под pyTelegramBotAPI
"""
...
# Telegram Bot - ИСПРАВЛЕННЫЙ ИМПОРТ
import telebot
from telebot import types

# OpenAI - ИСПРАВЛЕННЫЙ ИМПОРТ
from openai import OpenAI  # Не AsyncOpenAI!
...
class LesliAssistant:
    ...
    def __init__(self):
        self.setup_database()
        self.openai_client = OpenAI(api_key=config.OPENAI_API_KEY)  # Синхронный клиент
